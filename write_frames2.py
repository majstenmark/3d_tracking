...
def main():
    ...
    FILE = '/Users/maj/repos/3d_tracking/videos/yumi_square/yumi_square_right_sync.mp4'
    out_video = '/Users/maj/repos/3d_tracking/videos/yumi_square/yumi_square_right_sync_marked.mp4'
